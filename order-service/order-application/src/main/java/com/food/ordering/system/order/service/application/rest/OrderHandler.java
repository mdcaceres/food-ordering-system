...
public class OrderHandler {
    ...
    public OrderHandler(IOrderApplicationService orderApplicationService) {
    ...
    public ResponseEntity<TrackOrderResponse> getOrderByTrackingId(@PathVariable UUID trackingId) {
        ...
        log.info("Returning order status with tracking id: {}", trackOrderResponse.getOrderStatus());
